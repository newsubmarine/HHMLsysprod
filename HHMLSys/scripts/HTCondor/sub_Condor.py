...
def procJob(files, file_sizes, outDir, jobKey):
    ...
    if file_sizes_mb >= 4000 and file_sizes_mb <= 8000:
        memory = 3000
    elif file_sizes_mb > 8000 and file_sizes_mb < 1.5e4 :
        log.info('Request for more disk/memory resources for file > 8 Gb')
        memory = 4000    
    elif file_sizes_mb > 1.5e4:
        log.info('Request for more disk/memory resources for file > 15 Gb')
        memory = 8000
    else:
    ...
    for txtfiles in sorted(os.listdir(txtfilesDir)):
        ...
        if not options.Data:
            ...
            if sampleID not in {'450661', '450662', '450663',
                                ...
                                '364500', '364501', '364502', '364503', '364504', '364505', '364506', '364507', '364508', '364509', # Old Vgamma
                                ...
                                '410470', '410472',
                                '364100', '364101', '364102', '364103', '364104', '364105', '364106', '364107', '364108', '364109', '364110', '364111', '364112', '364113', '364114', '364115', '364116', '364117', '364118', '364119', '364120', '364121', '364122', '364123', '364124', '364125', '364126', '364127', '364128', '364129', '364130', '364131', '364132', '364133', '364134', '364135', '364136', '364137', '364138', '364139', '364140','364141',

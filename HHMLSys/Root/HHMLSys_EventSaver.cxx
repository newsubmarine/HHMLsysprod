...
double HHMLSys_EventSaver::getMCweight(const string& channel) {
  ...
  if(channel =="2l") {
    ...
    event_weight *= ( (abs(ntup.lep_ID_1) == 11) ? (ntup.lep_SF_El_Reco_AT_1 * ntup.lep_SF_El_ID_TightLH_AT_1 * ntup.lep_SF_El_PLVTight_1) : (ntup.lep_SF_Mu_TTVA_AT_1 * ntup.lep_SF_Mu_ID_Medium_1 * ntup.lep_SF_Mu_PLVTight_1) );
    event_weight *= ( (abs(ntup.lep_ID_2) == 11) ? (ntup.lep_SF_El_Reco_AT_2 * ntup.lep_SF_El_ID_TightLH_AT_2 * ntup.lep_SF_El_PLVTight_2) : (ntup.lep_SF_Mu_TTVA_AT_2 * ntup.lep_SF_Mu_ID_Medium_2 * ntup.lep_SF_Mu_PLVTight_2) );
  }
  else if(channel == "4l") {
    ...
    if( abs(ntup.lep_ID_0) == 11 && abs(ntup.lep_ID_1) == 11 ) event_weight *= ntup.lep_SF_El_Reco_AT_0 * ntup.lep_SF_El_Reco_AT_1 * ntup.lep_SF_El_ID_LooseAndBLayerLH_AT_0 * ntup.lep_SF_El_ID_LooseAndBLayerLH_AT_1 * ntup.lep_SF_El_PLVTight_0 * ntup.lep_SF_El_PLVTight_1 * ntup.lep_SF_El_ChargeMisID_LooseAndBLayerLH_FCLoose_AT_0 * ntup.lep_SF_El_ChargeMisID_LooseAndBLayerLH_FCLoose_AT_1;
    else if( abs(ntup.lep_ID_0) == 11 && abs(ntup.lep_ID_1) == 13 ) event_weight *= ntup.lep_SF_El_Reco_AT_0 * ntup.lep_SF_El_ID_LooseAndBLayerLH_AT_0 * ntup.lep_SF_El_PLVTight_0 * ntup.lep_SF_El_ChargeMisID_LooseAndBLayerLH_FCLoose_AT_0 * ntup.lep_SF_Mu_TTVA_AT_1 * ntup.lep_SF_Mu_ID_Medium_AT_1 * ntup.lep_SF_Mu_PLVTight_1;
    else if( abs(ntup.lep_ID_0) == 13 && abs(ntup.lep_ID_1) == 11 ) event_weight *= ntup.lep_SF_Mu_TTVA_AT_0 * ntup.lep_SF_Mu_ID_Medium_AT_0 * ntup.lep_SF_Mu_PLVTight_0 * ntup.lep_SF_El_Reco_AT_1 * ntup.lep_SF_El_ID_LooseAndBLayerLH_AT_1 * ntup.lep_SF_El_PLVTight_1 * ntup.lep_SF_El_ChargeMisID_LooseAndBLayerLH_FCLoose_AT_1;
    else if( abs(ntup.lep_ID_0) == 13 && abs(ntup.lep_ID_1 == 13) ) event_weight *= ntup.lep_SF_Mu_TTVA_AT_0 * ntup.lep_SF_Mu_TTVA_AT_1 * ntup.lep_SF_Mu_ID_Medium_AT_0 * ntup.lep_SF_Mu_ID_Medium_AT_1 * ntup.lep_SF_El_PLVTight_0 * ntup.lep_SF_Mu_PLVTight_1;  
  }
